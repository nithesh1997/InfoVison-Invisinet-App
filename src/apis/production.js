...
export const production = {
  ...
  hosts: {
    __default: {
      ...
      https: true, // Required, can be `true` or `false`.
      hostname: `${ProjectName.toLowerCase()}.com`, // Required, must be a string and a domain/subdomain without any other info like port, slashes, etc.
      port: 443, // Required, must be a number.
  ...
  paths: {
    "sign-in": {
      ...
      params: {
        ...
        // address: window.location.hostname, // All values must be parsed to check if any of them have a string with substring/s matching REGEX: `\{\{kw::[a-zA-Z-0-9_]+\}\}`. If there are they must be replace with actual values of those keywords.
      },
      headers: {
        "Content-Type": "application/json",
        Accept: "*/*",
    ...
    saveNats: {
      method: "POST", // Optional, "default-method" key of host will be used if not provided.
      host: "ba-sign-in-dev", // Option,al "__default" host will be used if not provided.
    ...
    getdir: {
      method: "GET", // Optional, "default-method" key of host will be used if not provided.
      host: "ba-api-dev", // Optional, "__default" host will be used if not provided.
      pathname: "/skylightweb/getDIRservers", // Required, must be a string starting with "/" and not ending with "/".
      params: {},
      headers: {
        "Content-Type": "application/json",
      },
    ...
    retryImportIdentity: {
      method: "POST",
      host: "ba-api-dev",
      pathname: "/skylightweb/retryImportIdentity",
      params: {},
      headers: { "Content-Type": "application/json", Accept: "*/*" },
    },
    linkApp: {
    ...
    unlinkApp: {
      method: "DELETE",
      host: "ba-api-dev",
      pathname: "/skylightweb/unlinkApp",
      params: {},
      headers: { "Content-Type": "application/json", Accept: "*/*" },
    },
  },
