...
export const Table = ({
  ...
  return (
    <Styled.Content>
      <Styled.Message theme={{ error: unQualified }}>
        {unQualified
          ? t("page.Endpoint.Configure.bulkTable.leftTable", {
              grammerly: grammerly,
            })
          : t("page.Endpoint.Configure.bulkTable.rightTable", {
              grammerly: grammerly,
            })}
      </Styled.Message>
          ...
          <Styled.TableHead style={{ width: "100%" }}>
            <Styled.TableHeadWrapper style={{ width: "100%" }}>
              <Styled.TableHeadCell
                style={{
                  textAlign: "center",
                  width: unQualified || isUpgradeRemoteFirmware ? "20%" : "40%",
                  borderRight: "1px solid #0094FD",
                }}
              >
                {t("page.Endpoint.Configure.bulkTable.name")}
              </Styled.TableHeadCell>
              <Styled.TableHeadCell
                style={{
                  textAlign: "center",
                  width: "60%",
                  borderRight:
                    unQualified || isUpgradeRemoteFirmware
                      ? "1px solid #0094FD"
                      : "",
                }}
              >
                {t("page.Endpoint.Configure.bulkTable.serial")}
              </Styled.TableHeadCell>
              ...
              {unQualified ? (
                ...
                >
                  {t("page.Endpoint.Configure.bulkTable.reason")}
                </Styled.TableHeadCell>
              ) : null}
              ...
              {isUpgradeRemoteFirmware ? (
                <Styled.TableHeadCell
                  style={{ textAlign: "center", width: "20%" }}
                >
                  {t("page.Endpoint.Configure.bulkTable.version")}
                </Styled.TableHeadCell>
              ) : null}
          ...
          <Styled.TableBody style={{ width: "100%" }}>
            ...
            >
              {loading === "loading" ? (
                ...
                >
                  <Typography>
                    {t("page.Endpoint.Configure.bulkTable.loading")}
                  </Typography>
                </Box>
              ) : (
                rows.map((data) => {
